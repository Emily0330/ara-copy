...
RISCV_FLAGS    ?= $(LLVM_FLAGS) $(LLVM_V_FLAGS) -mcmodel=medany -I$(CURDIR)/common -I$(LLVM_INSTALL_DIR)/riscv64-unknown-elf/include -std=gnu99 -O3 -ffast-math -fno-common -fno-builtin-printf $(DEFINES) $(RISCV_WARNINGS)
ifeq ($(LINUX),1)
...
RISCV_LDFLAGS  ?= -static -nostartfiles -nostdlib -nodefaultlibs -L$(LLVM_INSTALL_DIR)/riscv64-unknown-elf/lib -Wl,--gc-sections -T$(CURDIR)/common/link.ld
endif
...
RISCV_LDFLAGS_SPIKE  ?= -static -nostartfiles -nostdlib -nodefaultlibs -L$(LLVM_INSTALL_DIR)/riscv64-unknown-elf/lib $(SPIKE_LDFLAGS) -Wl,--gc-sections
